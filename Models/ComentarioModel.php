...
class ComentarioModel{
    ...
    public function GetComentarios(){
        $sentencia = $this->db->prepare("SELECT c.puntaje, u.nombre, c.comentario, c.fecha FROM comentario c INNER JOIN usuario u ON c.id_usuario = u.id_usuario  ORDER BY c.fecha AND c.puntaje");
